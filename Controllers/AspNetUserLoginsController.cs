...
namespace GameApp.Controllers
{
    ...
    public class AspNetUserLoginsController : Controller
    {
        ...
        public AspNetUserLoginsController(GameReviewDbContext context)
        {
            _context = context;
        }
        ...
        {
            var gameReviewDbContext = _context.AspNetUserLogins.Include(a => a.User);
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'GameReviewDbContext.AspNetUserLogins'  is null.");
            }
            var aspNetUserLogin = await _context.AspNetUserLogins.FindAsync(id);
            if (aspNetUserLogin != null)
            {
