...
namespace GameApp.Controllers
{
    ...
    public class AspNetRolesController : Controller
    {
        ...
        public AspNetRolesController(GameReviewDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.AspNetRoles != null ? 
                          ...
                          Problem("Entity set 'GameReviewDbContext.AspNetRoles'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'GameReviewDbContext.AspNetRoles'  is null.");
            }
            var aspNetRole = await _context.AspNetRoles.FindAsync(id);
            if (aspNetRole != null)
            {
