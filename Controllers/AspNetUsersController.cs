...
namespace GameApp.Controllers
{
    ...
    public class AspNetUsersController : Controller
    {
        ...
        public AspNetUsersController(GameReviewDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.AspNetUsers != null ? 
                          ...
                          Problem("Entity set 'GameReviewDbContext.AspNetUsers'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'GameReviewDbContext.AspNetUsers'  is null.");
            }
            var aspNetUser = await _context.AspNetUsers.FindAsync(id);
            if (aspNetUser != null)
            {
